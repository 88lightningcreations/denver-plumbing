    ...
    <div className="container my-5">
      <div className="row">
        <div className="col">
          ...
          <h2>CONTACT US</h2>
          <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at [EMAIL] or by mail using the details provided below:</p>
